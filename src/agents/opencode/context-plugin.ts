 ...
 *
 * `OPENCODE_CONFIG_DIR` points opencode at meeseex's own install dir additively: it does not
...
export const PROJECT_ROOT_ENV = "MEESEEX_PROJECT_ROOT";
...
export const MeeseexContextPlugin = async () => {
  return {
...
`;
  ...
  // restarting meeseex doesn't retrigger that every time.
